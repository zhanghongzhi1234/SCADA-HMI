...
namespace FreeSCADA.Designer.SchemaEditor.PropertiesUtils
{
	internal partial class NumExpressionBindingPanel: BaseBindingPanel
	{
		...
		public override void Initialize(object element, PropertyWrapper property, System.Windows.Data.BindingBase binding)
		{
            ...
            if (bind != null)
            {
                expressionEdit.Text = (bind.Converter as ExpressionScriptConverter).Expression;
                channels.Clear();
            ...
            {
                expressionEdit.Text = File.ReadAllText("FunctionsTemplate.txt");
            }
		}
		...
		public override System.Windows.Data.BindingBase Save()
		{
    		if (channels.Count > 0)
			{
                ...
                multiBind.Mode = BindingMode.Default;
                ExpressionScriptConverter scriptConverter = new ExpressionScriptConverter(expressionEdit.Text);

                multiBind.Converter = scriptConverter;
        ...
        {
            return StringResources.NumExpressionBindingPanelName;
        }

        private void btnViewLarge_Click(object sender, EventArgs e)
        {
            SharpCodeDialog dlg = new SharpCodeDialog(this.expressionEdit.Text);
            if (dlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                this.expressionEdit.Text = dlg.expression;
            }
        }
	}
    ...
    internal class NumExpressionBindingPanelFactory : BaseBindingPanelFactory
	{
		...
		override public bool CanWorkWithBinding(System.Windows.Data.BindingBase binding)
		{
			...
			{
				System.Windows.Data.MultiBinding bind = binding as System.Windows.Data.MultiBinding;
                if (bind.Converter is ExpressionScriptConverter == false)
					return false;
				return true;
			}
            return false;
