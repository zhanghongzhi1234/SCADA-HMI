...
namespace FreeSCADA.Communication.OPCPlug
{
    ...
    public class OPCBaseChannel:BaseChannel
	{
		...
		public OPCBaseChannel(string name, string hierarchy, Plugin plugin, string opcChannel, string opcServer, string opcHost)
            : base(name, hierarchy, false, plugin, typeof(object))
		{
